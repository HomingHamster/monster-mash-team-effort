...
//        persistIt.init();
        String enemy = "Gary";
        sendFightRequest(monster.getAggression(), monster.getStrength(), monster.getAge(), enemy);

    }

    public static void sendFightRequest(int aggression, int str, int age, String enemy) throws Exception {
        Gson gson = new Gson();         //Gson object for deserialization of the response
     URL url = new URL("http://193.60.15.159:8080/MMG6Main/FightServlet");
      //  URL url = new URL("http://192.168.43.75:8080/MonsterMash/FightServlet");
         ...
         */
        writer.write("aggr=" + aggression + "&" + "str=" + str + "&" + "age=" + age + "&" + "name=" + enemy);
        writer.flush();
