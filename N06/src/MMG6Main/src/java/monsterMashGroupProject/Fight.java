...
public class Fight {
     ...
     * @return 
     */
    public Monster determineWinner(Monster m1, 
            Monster m2) {
        int m1Prob = randomizeProbabilities(
                compareAttributesRetM1(m1, m2));
     ...
     * @return 
     */
    public int compareAttributesRetM1(Monster m1, 
            Monster m2) {
        ...
        stats1[0] = ((m1.getAggression() * 
                Worth.assessAge(m1)) / 10);
        stats1[1] = ((m1.getStrength() * 
                Worth.assessAge(m1)) / 10);
        stats2[0] = ((m2.getAggression() * 
                Worth.assessAge(m2)) / 10);
        stats2[1] = ((m2.getStrength() * 
                Worth.assessAge(m2)) / 10);
        ...
        m1Prob = (int) Math.round((finalStats[0] * 
                100.0) / total);
        return m1Prob;
    }
